	...
	const handleSendMessage = async () => {
		if (inputValue.trim() || selectedImages.length > 0) {
			...
			try {
				...
				// Replace loading message with actual response, including parsed tree if available
				setMessages((prev) =>
					prev.map((msg) =>
					...
					prev.map((msg) =>
						msg.id === loadingMessage.id
							? {
									...msg,
									content:
										"Przepraszam, wystąpił błąd podczas generowania odpowiedzi. Sprawdź konfigurację API.",
							  }
							: msg
					)
				);
						...
						>
							...
							>
								...
								<p className="whitespace-pre-wrap">
									{/* For assistant messages, remove code blocks and show only the text */}
